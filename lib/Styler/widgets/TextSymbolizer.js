...
Styler.TextSymbolizer = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        this.items = [this.attributesComboConfig, {
            ...
            symbolizer: {
                fillColor: this.symbolizer.fontColor,
                fillOpacity: this.symbolizer.fontOpacity
            },
            width: 220,
            labelWidth: 70,
            listeners: {
                change: function(symbolizer) {
                	this.symbolizer.fontColor = symbolizer.fillColor;
                	this.symbolizer.fontOpacity = symbolizer.fillOpacity;
                    this.fireEvent("change", this.symbolizer);
                },
                scope: this
            }
