...
Styler.PointSymbolizer = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
    	...
    	var logoUrl = this.urlSymbolizer ? this.urlSymbolizer : null;    	
        ...
        var updateTree = function(){
    		...
    		// request params
    		xhttp.open("GET", logoUrl +"/getFiles.json", true);    		
    		// fire request
    		xhttp.send();   		    		        	
        };
            ...
            buttons:[{
                ...
                listeners:{
                    ...
                    click:function(){
                    	...
                    	var format;
                    	var value = dataViewStyler.getSelectedRecords()[0].data.name;
                    	
                    	// set img format to display img in sld rule
                    	var posPoint=value.indexOf(".");
                    	if(posPoint > -1 ){
                    		format = value.substring( posPoint +1 , value.length );
                    		symbolizerPanel.symbolizer.graphicFormat="image/"+format;
                    	}                    	
                    	symbolizerPanel.symbolizer.externalGraphic = logoUrl+"/"+value;
